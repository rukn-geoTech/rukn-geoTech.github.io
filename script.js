...
const translations = {
  zh: {
    ...
    "biz-2-desc": "复杂油气藏地质建模、油藏数值模拟、智能算法优化研发，构建高精度三维地质模型，精准预测开发动态。",
    "biz-3-title": "地质 AI 应用开发",
    "biz-3-desc": "地质 AI 应用技术开发、油气勘探开发智能化方案定制，将深度学习与地质工程深度融合，打造行业专属 AI 工具。",
    "biz-4-title": "油田软件开发",
    "biz-4-desc": "油田行业专用小型软件、业务工具定制化开发与迭代升级，轻量化部署，快速响应业务需求。",
    "biz-5-title": "技术咨询",
    ...
    "adv-1-desc": "核心团队具备海外顶级能源企业一线油气项目实操经验，深耕油气勘探开发、油藏数模、地质建模领域多年，实战落地能力突出。",
    "adv-2-title": "产学研资源优势",
  ...
  en: {
    ...
    "biz-2-desc": "Complex reservoir geological modeling, numerical simulation, and intelligent algorithm optimization. Building high-precision 3D geological models for accurate development forecasts.",
    "biz-3-title": "Geological AI Development",
    "biz-3-desc": "Geological AI application development and customized intelligent exploration solutions. Deep integration of deep learning with geoscience engineering to create industry-specific AI tools.",
    "biz-4-title": "Oilfield Software Development",
    "biz-4-desc": "Custom development and iterative upgrades of specialized oilfield software and business tools. Lightweight deployment with rapid response to operational needs.",
    ...
    "adv-1-desc": "Our core team has hands-on experience from top-tier global energy companies, with years of expertise in oil and gas exploration, reservoir simulation, and geological modeling — delivering proven implementation capabilities.",
