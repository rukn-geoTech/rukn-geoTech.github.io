...
const translations = {
  ...
  en: {
    ...
    "biz-4-desc": "Custom development of practical tools, AI assistants, and business applications for the oilfield industry — fast to build, simple to deploy, ready to use. No project too big or small — if you have a need, we'll take it on.",
